...
class PagosControllerTest < ActionController::TestCase
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post :create, pago: { empresa_id: @pago.empresa_id, monto: @pago.monto, numero_vistas: @pago.numero_vistas }
    end
  ...
  test "should update pago" do
    patch :update, id: @pago, pago: { empresa_id: @pago.empresa_id, monto: @pago.monto, numero_vistas: @pago.numero_vistas }
    assert_redirected_to pago_path(assigns(:pago))
  end
